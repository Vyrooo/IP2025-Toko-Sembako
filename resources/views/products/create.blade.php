            ...
            <form method="POST" action="{{ route('admin.products.store') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="purchase_price" class="form-control @error('purchase_price') is-invalid @enderror" value="{{ old('purchase_price') }}" step="0.01" min="0" required>
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="unit" class="form-select @error('unit') is-invalid @enderror" required>
                                ...
                                <option value="renteng" @selected(old('unit') == 'renteng')>renteng</option>
                        </select>
